                        ...
                        ConfigCategory.createBuilder()
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(OptionDescription.of(Component.literal("Shows the current FPS")))
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(
                                                        OptionDescription.of(Component.literal("Shows the current coordinates")))
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(OptionDescription.of(Component.literal("Shows the current ping")))
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(
                                                        OptionDescription.of(Component.literal("Shows the current connection/IP")))
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(OptionDescription.of(Component.literal("Shows the current biome")))
                        ...
                        ConfigCategory.createBuilder()
                                ...
                                .option(
                                        Option.<Integer>createBuilder()
                                                ...
                                                .description(
                                                        OptionDescription.of(
                                                                Component.literal("Sets the horizontal position of the HUD elements")))
                        ...
                        ConfigCategory.createBuilder()
                                ...
                                .option(
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(OptionDescription.of(Component.literal("Makes Coordinates gay")))
